    ...
    <div>
      ...
      <ul font-base list-circle space-y-2>
        ...
        <li>
          ...
          Server and leveraging caching methodologies, leading to a 40% decrease
          in API calls and a notable improvement in system performance.
        </li>
      </ul>
    </div>
  </div>
